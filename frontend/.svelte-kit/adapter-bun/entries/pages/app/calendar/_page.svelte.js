import { a0 as escape_html, a4 as ensure_array_like, a7 as attr_class, a2 as attr } from "../../../../chunks/index2.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    for (let i = 0, $$length = each_array_1.length; i < $$length; i++) {
      ...
      $$renderer2.push(`<div${attr_class("h-32 glass-card p-2 cursor-pointer transition relative overflow-hidden hover:border-primary/50 group flex flex-col", void 0, { "border-primary": isToday, "bg-primary-10": isToday })}><span${attr_class("font-bold text-gray-300 group-hover:text-white transition", void 0, { "text-primary": isToday })}>${escape_html(day)}</span> <div class="mt-1 space-y-1 overflow-y-auto scrollbar-hide w-full flex-grow"><!--[-->`);
