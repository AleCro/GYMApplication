import { attr, attr_class, bind_props, ensure_array_like, escape_html, head, stringify } from "./index2-BLSeo-Vt.js";
import "./clsx-cC83_lR5.js";
import "./chunks-DNg0X1yh.js";
import { public_env } from "./shared-server-aoX5LlPz.js";
import { onDestroy, userStore } from "./stores-C-8AFukU.js";
import { cookies } from "./cookie-toVUY8nI.js";

//#region .svelte-kit/adapter-bun/entries/pages/app/user-management/_page.svelte.js
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer2) => {
		...
		data.user;
		if (users.length === 0 && !isLoading) fetchUsers(currentPage);
...
//# sourceMappingURL=_page.svelte-C5w_vU8Z.js.map