//#region .svelte-kit/adapter-bun/chunks/cookie.js
var CookieHandler = class {
	constructor() {
		return new Proxy(this, {
			get: (target, name) => {
				if (typeof name === "string" && !name.startsWith("_") && target.getCookie(name) !== void 0) return target.getCookie(name);
				return target[name];
			},
	...
	*/
	getCookie(name) {
		...
		for (const cookie of cookies2) if (cookie.startsWith(name + "=")) return decodeURIComponent(cookie.substring(name.length + 1));
		return void 0;
	}
	/**
	...
	*/
	setCookie(name, value, attributes = {}) {
		...
		for (let key in attributes) {
			cookieString += `; ${key}`;
			if (attributes[key] !== true) cookieString += `=${attributes[key]}`;
		}
...
//#endregion
export { cookies };
//# sourceMappingURL=cookie-toVUY8nI.js.map